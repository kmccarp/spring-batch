...
/**
 * The {@link LdifReader LdifReader} is an adaptation of the
 * {@link org.springframework.batch.item.file.FlatFileItemReader FlatFileItemReader} built
 * around an {@link LdifParser LdifParser}.
 * <p>
 * Unlike the {@link org.springframework.batch.item.file.FlatFileItemReader
 * FlatFileItemReader}, the {@link LdifReader LdifReader} does not require a mapper.
 * Instead, this version of the {@link LdifReader LdifReader} simply returns an
 * {@link LdapAttributes LdapAttributes} object which can be consumed and manipulated as
 * necessary by {@link org.springframework.batch.item.ItemProcessor ItemProcessor} or any
 ...
 * objects for return.
 * <p>
 * {@link LdifReader LdifReader} usage is mimics that of the
 * {@link org.springframework.batch.item.file.FlatFileItemReader FlatFileItemReader} for
 * all intensive purposes. Adjustments have been made to process records instead of lines,
 * however. As such, the {@link #recordsToSkip recordsToSkip} attribute indicates the
 * number of records from the top of the file that should not be processed.
 * Implementations of the {@link RecordCallbackHandler RecordCallbackHandler} interface
