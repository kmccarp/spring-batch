...
/**
 * {@link FieldExtractor} that just returns the original item. If the item is an array or
 * collection it will be returned as is, otherwise it is wrapped in a single element
 * array.
 *
 * @author Dave Syer
 *
